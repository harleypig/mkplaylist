...
class LastFmClient:
    ...
    def get_recent_tracks(self, username: Optional[str] = None, limit: int = 50,
        ...
        # Get recent tracks
        raw_tracks = user.get_recent_tracks(limit=limit, time_from=from_timestamp, time_to=to_timestamp)
        ...
        for track in raw_tracks:
            track_dict = {
                ...
                'played_at': datetime.fromtimestamp(int(track.timestamp)) if track.timestamp else None,
    ...
    def get_top_tracks(self, username: Optional[str] = None, period: str = "overall", limit: int = 50) -> List[Dict[str, Any]]:
        """
    ...
    def get_track_info(self, artist: str, track: str, username: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def scrobble_track(self, artist: str, track: str, timestamp: Optional[datetime] = None) -> bool:
        """
