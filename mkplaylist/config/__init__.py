...
def register_service_config(config_class: Type[ServiceConfig]) -> None:
    ...
    try:
        ...
        logger.warning(f"Failed to register service configuration {config_class.__name__}: {e}")
    ...
    def _load_service_configs(self) -> None:
        ...
        for service_name, config_class in _service_configs.items():
            try:
                ...
                logger.warning(f"Failed to load service configuration for '{service_name}': {e}")
