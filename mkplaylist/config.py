...
def data_dir() -> Path:
# Backward compatibility functions for old function names
def get_data_dir() -> Path:
  """
  Backward compatibility function for get_data_dir().
...
def get_config_dir() -> Path:
  """
  Backward compatibility function for get_config_dir().
...
def get_cache_dir() -> Path:
  """
  Backward compatibility function for get_cache_dir().
...
def get_state_dir() -> Path:
  """
  Backward compatibility function for get_state_dir().
...
def get_db_path() -> Path:
  """
  Backward compatibility function for get_db_path().
...
def validate_config() -> Dict[str, Any]:
  """
  Backward compatibility function for validate_config().
...
def get_config_status() -> Dict[str, bool]:
  """
  Backward compatibility function for get_config_status().
...
def get_config_sources() -> Dict[str, str]:
  """
  Backward compatibility function for get_config_sources().
