...
class PlaylistService:
    ...
    def create_playlist(self, name: str, criteria: str, description: Optional[str] = None,
                       public: bool = False, collaborative: bool = False,
                       replace: bool = False, limit: Optional[int] = None) -> Dict[str, Any]:
        """
        ...
        if existing_playlist:
            ...
            # Get track URIs
            track_uris = [f"spotify:track:{track.spotify_id}" for track in tracks if track.spotify_id]
            ...
            playlist = self.spotify_client.create_playlist(
                name=name,
                description=description or f"Created by mkplaylist with criteria: {criteria}",
                public=public
            )
    ...
    def list_playlists(self, format: str = 'table', sort: str = 'updated') -> List[Dict[str, Any]]:
        """
