...
class SyncService:
    ...
    def sync_spotify_playlists(self, full_sync: bool = False) -> Dict[str, Any]:
        ...
        for playlist in playlists:
            ...
            if not full_sync and not is_new_playlist:
                logger.info(f"Skipping tracks for playlist {playlist_name} (not a full sync)")
                continue
    ...
    def sync_lastfm_history(self, days: int = 30, username: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def sync_all(self, full_sync: bool = False, days: int = 30, 
                spotify_only: bool = False, lastfm_only: bool = False) -> Dict[str, Any]:
        """
